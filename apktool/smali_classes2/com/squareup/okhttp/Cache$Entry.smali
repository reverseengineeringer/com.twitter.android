...
.method public constructor <init>(Lokio/ab;)V
    ...
    .line 529
    invoke-interface {v2}, Lokio/j;->s()Ljava/lang/String;
    ...
    .line 532
    # invokes: Lcom/squareup/okhttp/Cache;->readInt(Lokio/j;)I
    invoke-static {v2}, Lcom/squareup/okhttp/Cache;->access$1000(Lokio/j;)I
    ...
    .line 555
    invoke-direct {p0, v2}, Lcom/squareup/okhttp/Cache$Entry;->readCertificateList(Lokio/j;)Ljava/util/List;
...
.method private readCertificateList(Lokio/j;)Ljava/util/List;
    .locals 6
    ...
    .line 619
    # invokes: Lcom/squareup/okhttp/Cache;->readInt(Lokio/j;)I
    invoke-static {p1}, Lcom/squareup/okhttp/Cache;->access$1000(Lokio/j;)I
...
.method private writeCertList(Lokio/i;Ljava/util/List;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, Lokio/i;->i(I)Lokio/i;
...
.method public writeTo(Lcom/squareup/okhttp/internal/DiskLruCache$Editor;)V
    ...
    .line 578
    invoke-virtual {p1, v0}, Lcom/squareup/okhttp/internal/DiskLruCache$Editor;->newSink(I)Lokio/aa;
    ...
    invoke-direct {p0, v2, v0}, Lcom/squareup/okhttp/Cache$Entry;->writeCertList(Lokio/i;Ljava/util/List;)V
