...
# direct methods
.method public constructor <init>(ZLokio/j;Lokio/i;Ljava/util/Random;Ljava/util/concurrent/Executor;Lcom/squareup/okhttp/ws/WebSocketListener;Ljava/lang/String;)V
    .locals 2
    ...
    invoke-direct {v0, p1, p3, p4}, Lcom/squareup/okhttp/internal/ws/WebSocketWriter;-><init>(ZLokio/i;Ljava/util/Random;)V
    ...
    invoke-direct {v0, p1, p2, v1}, Lcom/squareup/okhttp/internal/ws/WebSocketReader;-><init>(ZLokio/j;Lcom/squareup/okhttp/internal/ws/WebSocketReader$FrameCallback;)V
...
.method public sendMessage(Lcom/squareup/okhttp/RequestBody;)V
    ...
    invoke-virtual {v2, v0}, Lcom/squareup/okhttp/internal/ws/WebSocketWriter;->newMessageSink(I)Lokio/aa;
    ...
    .line 130
    :try_start_0
    invoke-virtual {p1, v0}, Lcom/squareup/okhttp/RequestBody;->writeTo(Lokio/i;)V
...
.method public sendPing(Lokio/f;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p1}, Lcom/squareup/okhttp/internal/ws/WebSocketWriter;->writePing(Lokio/f;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public sendPong(Lokio/f;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p1}, Lcom/squareup/okhttp/internal/ws/WebSocketWriter;->writePong(Lokio/f;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
