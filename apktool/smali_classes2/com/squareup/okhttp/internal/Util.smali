...
.method public static discard(Lokio/ab;ILjava/util/concurrent/TimeUnit;)Z
    .locals 1

    .prologue
    .line 141
    :try_start_0
    invoke-static {p0, p1, p2}, Lcom/squareup/okhttp/internal/Util;->skipAll(Lokio/ab;ILjava/util/concurrent/TimeUnit;)Z
    :try_end_0
...
.method public static skipAll(Lokio/ab;ILjava/util/concurrent/TimeUnit;)Z
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public static toHumanReadableAscii(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 273
    invoke-virtual {v4, p0, v1, v0}, Lokio/f;->a(Ljava/lang/String;II)Lokio/f;
    ...
    :goto_2
    invoke-virtual {v4, v0}, Lokio/f;->a(I)Lokio/f;
    ...
    .line 278
    :cond_2
    invoke-virtual {v4}, Lokio/f;->r()Ljava/lang/String;
