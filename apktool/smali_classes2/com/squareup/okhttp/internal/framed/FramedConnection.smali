...
.method private constructor <init>(Lcom/squareup/okhttp/internal/framed/FramedConnection$Builder;)V
    ...
    # getter for: Lcom/squareup/okhttp/internal/framed/FramedConnection$Builder;->sink:Lokio/i;
    invoke-static {p1}, Lcom/squareup/okhttp/internal/framed/FramedConnection$Builder;->access$600(Lcom/squareup/okhttp/internal/framed/FramedConnection$Builder;)Lokio/i;

    move-result-object v1

    iget-boolean v2, p0, Lcom/squareup/okhttp/internal/framed/FramedConnection;->client:Z

    invoke-interface {v0, v1, v2}, Lcom/squareup/okhttp/internal/framed/Variant;->newWriter(Lokio/i;Z)Lcom/squareup/okhttp/internal/framed/FrameWriter;
    ...
    # getter for: Lcom/squareup/okhttp/internal/framed/FramedConnection$Builder;->source:Lokio/j;
    invoke-static {p1}, Lcom/squareup/okhttp/internal/framed/FramedConnection$Builder;->access$700(Lcom/squareup/okhttp/internal/framed/FramedConnection$Builder;)Lokio/j;

    move-result-object v2

    iget-boolean v3, p0, Lcom/squareup/okhttp/internal/framed/FramedConnection;->client:Z

    invoke-interface {v1, v2, v3}, Lcom/squareup/okhttp/internal/framed/Variant;->newReader(Lokio/j;Z)Lcom/squareup/okhttp/internal/framed/FrameReader;
...
.method static synthetic access$1400(Lcom/squareup/okhttp/internal/framed/FramedConnection;ILokio/j;IZ)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .prologue
    .line 55
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/squareup/okhttp/internal/framed/FramedConnection;->pushDataLater(ILokio/j;IZ)V
...
.method private pushDataLater(ILokio/j;IZ)V
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/squareup/okhttp/internal/framed/FramedConnection$6;-><init>(Lcom/squareup/okhttp/internal/framed/FramedConnection;Ljava/lang/String;[Ljava/lang/Object;ILokio/f;IZ)V
...
.method public writeData(IZLokio/f;J)V
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {v0, p2, p1, p3, v1}, Lcom/squareup/okhttp/internal/framed/FrameWriter;->data(ZILokio/f;I)V
    ...
    :goto_0
    invoke-interface {v3, v0, p1, p3, v2}, Lcom/squareup/okhttp/internal/framed/FrameWriter;->data(ZILokio/f;I)V
