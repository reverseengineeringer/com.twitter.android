...
.field private static final NULL_SINK:Lokio/aa;
...
.field private journalWriter:Lokio/i;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/squareup/okhttp/internal/DiskLruCache;->NULL_SINK:Lokio/aa;
...
.method static synthetic access$2500()Lokio/aa;
    .locals 1

    .prologue
    .line 88
    sget-object v0, Lcom/squareup/okhttp/internal/DiskLruCache;->NULL_SINK:Lokio/aa;
...
.method private declared-synchronized completeEdit(Lcom/squareup/okhttp/internal/DiskLruCache$Editor;Z)V
    ...
    .line 554
    iget-object v0, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lokio/i;
    ...
    invoke-virtual {v2, v0}, Lcom/squareup/okhttp/internal/DiskLruCache$Entry;->writeLengths(Lokio/i;)V
...
.method private declared-synchronized edit(Ljava/lang/String;J)Lcom/squareup/okhttp/internal/DiskLruCache$Editor;
    ...
    .line 464
    :cond_2
    iget-object v2, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lokio/i;
...
.method private newJournalWriter()Lokio/i;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-interface {v0, v1}, Lcom/squareup/okhttp/internal/io/FileSystem;->appendingSink(Ljava/io/File;)Lokio/aa;
    ...
    invoke-direct {v1, p0, v0}, Lcom/squareup/okhttp/internal/DiskLruCache$2;-><init>(Lcom/squareup/okhttp/internal/DiskLruCache;Lokio/aa;)V
...
.method private readJournal()V
    ...
    invoke-interface {v0, v1}, Lcom/squareup/okhttp/internal/io/FileSystem;->source(Ljava/io/File;)Lokio/ab;
    ...
    :cond_2
    :try_start_3
    invoke-direct {p0}, Lcom/squareup/okhttp/internal/DiskLruCache;->newJournalWriter()Lokio/i;

    move-result-object v0

    iput-object v0, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lokio/i;
    :try_end_3
...
.method private declared-synchronized rebuildJournal()V
    ...
    invoke-interface {v0, v1}, Lcom/squareup/okhttp/internal/io/FileSystem;->sink(Ljava/io/File;)Lokio/aa;
    ...
    .line 398
    invoke-virtual {v0, v1}, Lcom/squareup/okhttp/internal/DiskLruCache$Entry;->writeLengths(Lokio/i;)V
...
.method public declared-synchronized get(Ljava/lang/String;)Lcom/squareup/okhttp/internal/DiskLruCache$Snapshot;
    ...
    .line 433
    iget-object v1, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lokio/i;
