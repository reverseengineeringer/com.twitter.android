.class Lcom/crashlytics/android/core/by;
...
.field private final e:Lcom/crashlytics/android/core/at;
...
.method public constructor <init>(Lcom/crashlytics/android/core/at;)V
    .locals 2
    ...
    .line 46
    :cond_0
    iput-object p1, p0, Lcom/crashlytics/android/core/by;->e:Lcom/crashlytics/android/core/at;

    .line 47
    return-void
.end method

.method static synthetic a(Lcom/crashlytics/android/core/by;Ljava/lang/Thread;)Ljava/lang/Thread;
    .locals 0

    .prologue
    .line 23
    iput-object p1, p0, Lcom/crashlytics/android/core/by;->f:Ljava/lang/Thread;
...
.method a()Ljava/util/List;
    ...
    .line 104
    iget-object v1, p0, Lcom/crashlytics/android/core/by;->d:Ljava/lang/Object;
    ...
    sget-object v2, Lcom/crashlytics/android/core/by;->b:Ljava/io/FilenameFilter;
    ...
    .line 111
    new-instance v5, Lcom/crashlytics/android/core/cc;

    invoke-direct {v5, v4}, Lcom/crashlytics/android/core/cc;-><init>(Ljava/io/File;)V
...
.method public declared-synchronized a(F)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/crashlytics/android/core/by;->f:Ljava/lang/Thread;
    ...
    iput-object v0, p0, Lcom/crashlytics/android/core/by;->f:Ljava/lang/Thread;
...
.method a(Lcom/crashlytics/android/core/bx;)Z
    .locals 7
    ...
    invoke-virtual {v1}, Lcom/crashlytics/android/core/f;->E()Landroid/content/Context;

    move-result-object v1

    .line 79
    new-instance v3, Lcom/crashlytics/android/core/as;

    new-instance v4, Lio/fabric/sdk/android/services/common/k;

    invoke-direct {v4}, Lio/fabric/sdk/android/services/common/k;-><init>()V

    invoke-virtual {v4, v1}, Lio/fabric/sdk/android/services/common/k;->a(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v1

    invoke-direct {v3, v1, p1}, Lcom/crashlytics/android/core/as;-><init>(Ljava/lang/String;Lcom/crashlytics/android/core/bx;)V

    .line 81
    iget-object v1, p0, Lcom/crashlytics/android/core/by;->e:Lcom/crashlytics/android/core/at;

    invoke-interface {v1, v3}, Lcom/crashlytics/android/core/at;->a(Lcom/crashlytics/android/core/as;)Z
    ...
    invoke-interface {v4, v5, v1}, Lio/fabric/sdk/android/s;->c(Ljava/lang/String;Ljava/lang/String;)V

    .line 86
    if-eqz v3, :cond_0

    .line 87
    invoke-interface {p1}, Lcom/crashlytics/android/core/bx;->a()Z
    :try_end_0
