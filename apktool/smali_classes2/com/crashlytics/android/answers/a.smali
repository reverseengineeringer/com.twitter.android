...
# instance fields
.field a:Lcom/crashlytics/android/answers/y;
...
.method public a()Ljava/lang/String;
    ...
    .prologue
    .line 401
    const-string/jumbo v0, "1.3.8.127"

    return-object v0
.end method

.method public a(Lio/fabric/sdk/android/services/common/o;)V
    .locals 3

    .prologue
    .line 332
    iget-object v0, p0, Lcom/crashlytics/android/answers/a;->a:Lcom/crashlytics/android/answers/y;
    ...
    invoke-virtual {p1}, Lio/fabric/sdk/android/services/common/o;->a()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lio/fabric/sdk/android/services/common/o;->b()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lcom/crashlytics/android/answers/y;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public a(Lio/fabric/sdk/android/services/common/p;)V
    .locals 2
    ...
    invoke-virtual {p1}, Lio/fabric/sdk/android/services/common/p;->a()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/crashlytics/android/answers/y;->a(Ljava/lang/String;)V
...
.method protected a_()Z
    ...
    .line 341
    :try_start_0
    invoke-virtual {p0}, Lcom/crashlytics/android/answers/a;->E()Landroid/content/Context;
    ...
    .line 358
    :goto_1
    invoke-virtual {p0}, Lcom/crashlytics/android/answers/a;->D()Lio/fabric/sdk/android/services/common/IdManager;

    move-result-object v3

    move-object v1, p0

    invoke-static/range {v1 .. v7}, Lcom/crashlytics/android/answers/y;->a(Lio/fabric/sdk/android/p;Landroid/content/Context;Lio/fabric/sdk/android/services/common/IdManager;Ljava/lang/String;Ljava/lang/String;J)Lcom/crashlytics/android/answers/y;

    move-result-object v1

    iput-object v1, p0, Lcom/crashlytics/android/answers/a;->a:Lcom/crashlytics/android/answers/y;

    .line 360
    iget-object v1, p0, Lcom/crashlytics/android/answers/a;->a:Lcom/crashlytics/android/answers/y;
...
.method protected d()Ljava/lang/Boolean;
    ...
    iget-object v0, v0, Lio/fabric/sdk/android/services/settings/v;->e:Lio/fabric/sdk/android/services/settings/b;

    invoke-virtual {p0}, Lcom/crashlytics/android/answers/a;->e()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v0, v2}, Lcom/crashlytics/android/answers/y;->a(Lio/fabric/sdk/android/services/settings/b;Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/crashlytics/android/answers/y;->c()V
