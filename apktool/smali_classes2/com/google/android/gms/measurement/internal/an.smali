...
# instance fields
.field final synthetic a:Lcom/google/android/gms/measurement/internal/ak;


# direct methods
.method constructor <init>(Lcom/google/android/gms/measurement/internal/ak;Landroid/content/Context;Ljava/lang/String;)V
    .locals 2

    iput-object p1, p0, Lcom/google/android/gms/measurement/internal/an;->a:Lcom/google/android/gms/measurement/internal/ak;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/android/gms/measurement/internal/an;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, p1, p2, p4, p5}, Lcom/google/android/gms/measurement/internal/an;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    :try_end_0
    ...
    iget-object v1, p0, Lcom/google/android/gms/measurement/internal/an;->a:Lcom/google/android/gms/measurement/internal/ak;

    invoke-virtual {v1}, Lcom/google/android/gms/measurement/internal/ak;->s()Lcom/google/android/gms/measurement/internal/bc;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    .locals 6
    .annotation build Landroid/support/annotation/WorkerThread;
    .end annotation
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/android/gms/measurement/internal/an;->b(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    :goto_1
    :try_start_2
    iget-object v2, p0, Lcom/google/android/gms/measurement/internal/an;->a:Lcom/google/android/gms/measurement/internal/ak;

    invoke-virtual {v2}, Lcom/google/android/gms/measurement/internal/ak;->s()Lcom/google/android/gms/measurement/internal/bc;
    ...
    invoke-virtual {v2, v3, p2, v0}, Lcom/google/android/gms/measurement/internal/be;->a(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_2
...
.method public getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v0, p0, Lcom/google/android/gms/measurement/internal/an;->a:Lcom/google/android/gms/measurement/internal/ak;

    invoke-static {v0}, Lcom/google/android/gms/measurement/internal/ak;->a(Lcom/google/android/gms/measurement/internal/ak;)Lcom/google/android/gms/measurement/internal/ac;

    move-result-object v0

    iget-object v1, p0, Lcom/google/android/gms/measurement/internal/an;->a:Lcom/google/android/gms/measurement/internal/ak;

    invoke-virtual {v1}, Lcom/google/android/gms/measurement/internal/ak;->u()Lcom/google/android/gms/measurement/internal/aj;

    move-result-object v1

    invoke-virtual {v1}, Lcom/google/android/gms/measurement/internal/aj;->G()J

    move-result-wide v2

    invoke-virtual {v0, v2, v3}, Lcom/google/android/gms/measurement/internal/ac;->a(J)Z
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/measurement/internal/ak;->s()Lcom/google/android/gms/measurement/internal/bc;
    ...
    invoke-static {v0}, Lcom/google/android/gms/measurement/internal/ak;->b(Lcom/google/android/gms/measurement/internal/ak;)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lcom/google/android/gms/measurement/internal/an;->a:Lcom/google/android/gms/measurement/internal/ak;

    invoke-virtual {v1}, Lcom/google/android/gms/measurement/internal/ak;->m()Landroid/content/Context;
    ...
    invoke-static {v1}, Lcom/google/android/gms/measurement/internal/ak;->a(Lcom/google/android/gms/measurement/internal/ak;)Lcom/google/android/gms/measurement/internal/ac;

    move-result-object v1

    invoke-virtual {v1}, Lcom/google/android/gms/measurement/internal/ac;->b()V
    :try_end_1
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_1 .. :try_end_1} :catch_1
...
.method public onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/google/android/gms/measurement/internal/an;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {}, Lcom/google/android/gms/measurement/internal/ak;->D()Ljava/util/Map;
    ...
    invoke-direct/range {v6 .. v11}, Lcom/google/android/gms/measurement/internal/an;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
