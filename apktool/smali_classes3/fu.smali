...
# direct methods
.method protected constructor <init>(Lcom/facebook/imagepipeline/producers/bw;Lcom/facebook/imagepipeline/producers/ce;Lgo;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 38
    iput-object p2, p0, Lfu;->a:Lcom/facebook/imagepipeline/producers/ce;

    .line 39
    iput-object p3, p0, Lfu;->b:Lgo;

    .line 40
    iget-object v0, p0, Lfu;->b:Lgo;

    invoke-virtual {p2}, Lcom/facebook/imagepipeline/producers/ce;->a()Lcom/facebook/imagepipeline/request/ImageRequest;

    move-result-object v1

    iget-object v2, p0, Lfu;->a:Lcom/facebook/imagepipeline/producers/ce;

    invoke-virtual {v2}, Lcom/facebook/imagepipeline/producers/ce;->d()Ljava/lang/Object;

    move-result-object v2

    iget-object v3, p0, Lfu;->a:Lcom/facebook/imagepipeline/producers/ce;

    invoke-virtual {v3}, Lcom/facebook/imagepipeline/producers/ce;->b()Ljava/lang/String;

    move-result-object v3

    iget-object v4, p0, Lfu;->a:Lcom/facebook/imagepipeline/producers/ce;

    invoke-virtual {v4}, Lcom/facebook/imagepipeline/producers/ce;->f()Z

    move-result v4

    invoke-interface {v0, v1, v2, v3, v4}, Lgo;->a(Lcom/facebook/imagepipeline/request/ImageRequest;Ljava/lang/Object;Ljava/lang/String;Z)V

    .line 45
    invoke-direct {p0}, Lfu;->j()Lcom/facebook/imagepipeline/producers/o;
...
.method static synthetic a(Lfu;)V
    .locals 0

    .prologue
    .line 29
    invoke-direct {p0}, Lfu;->k()V

    return-void
.end method

.method static synthetic a(Lfu;Ljava/lang/Throwable;)V
    .locals 0

    .prologue
    .line 29
    invoke-direct {p0, p1}, Lfu;->b(Ljava/lang/Throwable;)V

    return-void
.end method

.method static synthetic a(Lfu;F)Z
    .locals 1

    .prologue
    .line 29
    invoke-virtual {p0, p1}, Lfu;->a(F)Z
...
.method private b(Ljava/lang/Throwable;)V
    ...
    iget-object v1, p0, Lfu;->a:Lcom/facebook/imagepipeline/producers/ce;
    ...
    invoke-interface {v0, v1, v2, p1, v3}, Lgo;->a(Lcom/facebook/imagepipeline/request/ImageRequest;Ljava/lang/String;Ljava/lang/Throwable;Z)V
...
.method protected b(Ljava/lang/Object;Z)V
    ...
    invoke-interface {v0, v1, v2, v3}, Lgo;->a(Lcom/facebook/imagepipeline/request/ImageRequest;Ljava/lang/String;Z)V
...
.method public h()Z
    ...
    invoke-interface {v0, v1}, Lgo;->a(Ljava/lang/String;)V

    .line 104
    iget-object v0, p0, Lfu;->a:Lcom/facebook/imagepipeline/producers/ce;
