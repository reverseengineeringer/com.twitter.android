.class Lio/fabric/sdk/android/t;
...
# instance fields
.field private final a:Lio/fabric/sdk/android/services/network/j;
...
.method public constructor <init>(Ljava/util/concurrent/Future;Ljava/util/Collection;)V
    ...
    iput-object v0, p0, Lio/fabric/sdk/android/t;->a:Lio/fabric/sdk/android/services/network/j;

    .line 63
    iput-object p1, p0, Lio/fabric/sdk/android/t;->p:Ljava/util/concurrent/Future;

    .line 64
    iput-object p2, p0, Lio/fabric/sdk/android/t;->q:Ljava/util/Collection;
...
.method private a(Lio/fabric/sdk/android/services/settings/n;Ljava/util/Collection;)Lio/fabric/sdk/android/services/settings/d;
    ...
    .prologue
    .line 208
    invoke-virtual {p0}, Lio/fabric/sdk/android/t;->E()Landroid/content/Context;
    ...
    invoke-virtual {v1, v0}, Lio/fabric/sdk/android/services/common/k;->a(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 213
    iget-object v0, p0, Lio/fabric/sdk/android/t;->m:Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lio/fabric/sdk/android/services/common/DeliveryMechanism;->a()I

    move-result v7

    .line 214
    invoke-virtual {p0}, Lio/fabric/sdk/android/t;->D()Lio/fabric/sdk/android/services/common/IdManager;
    ...
    iget-object v3, p0, Lio/fabric/sdk/android/t;->l:Ljava/lang/String;

    iget-object v4, p0, Lio/fabric/sdk/android/t;->k:Ljava/lang/String;

    iget-object v6, p0, Lio/fabric/sdk/android/t;->n:Ljava/lang/String;

    iget-object v8, p0, Lio/fabric/sdk/android/t;->o:Ljava/lang/String;
...
.method private a(Lio/fabric/sdk/android/services/settings/e;Lio/fabric/sdk/android/services/settings/n;Ljava/util/Collection;)Z
    ...
    .prologue
    .line 202
    invoke-direct {p0, p2, p3}, Lio/fabric/sdk/android/t;->a(Lio/fabric/sdk/android/services/settings/n;Ljava/util/Collection;)Lio/fabric/sdk/android/services/settings/d;

    move-result-object v0

    .line 203
    new-instance v1, Lio/fabric/sdk/android/services/settings/aa;

    invoke-virtual {p0}, Lio/fabric/sdk/android/t;->e()Ljava/lang/String;

    move-result-object v2

    iget-object v3, p1, Lio/fabric/sdk/android/services/settings/e;->c:Ljava/lang/String;

    iget-object v4, p0, Lio/fabric/sdk/android/t;->a:Lio/fabric/sdk/android/services/network/j;

    invoke-direct {v1, p0, v2, v3, v4}, Lio/fabric/sdk/android/services/settings/aa;-><init>(Lio/fabric/sdk/android/p;Ljava/lang/String;Ljava/lang/String;Lio/fabric/sdk/android/services/network/j;)V

    invoke-virtual {v1, v0}, Lio/fabric/sdk/android/services/settings/aa;->a(Lio/fabric/sdk/android/services/settings/d;)Z
...
.method private a(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
    ...
    .line 157
    invoke-direct {p0, p1, p2, p3}, Lio/fabric/sdk/android/t;->b(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
    ...
    .line 175
    invoke-direct {p0, p1, p2, p3}, Lio/fabric/sdk/android/t;->c(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
...
.method private b(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
    ...
    invoke-direct {p0, v0, p3}, Lio/fabric/sdk/android/t;->a(Lio/fabric/sdk/android/services/settings/n;Ljava/util/Collection;)Lio/fabric/sdk/android/services/settings/d;
    ...
    invoke-direct {v1, p0, v2, v3, v4}, Lio/fabric/sdk/android/services/settings/h;-><init>(Lio/fabric/sdk/android/p;Ljava/lang/String;Ljava/lang/String;Lio/fabric/sdk/android/services/network/j;)V
...
.method private c(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
    ...
    invoke-direct {p0, p2, v0, p3}, Lio/fabric/sdk/android/t;->a(Lio/fabric/sdk/android/services/settings/e;Lio/fabric/sdk/android/services/settings/n;Ljava/util/Collection;)Z
...
.method private g()Lio/fabric/sdk/android/services/settings/v;
    .locals 7
    ...
    iget-object v2, p0, Lio/fabric/sdk/android/t;->i:Lio/fabric/sdk/android/services/common/IdManager;

    iget-object v3, p0, Lio/fabric/sdk/android/t;->a:Lio/fabric/sdk/android/services/network/j;

    iget-object v4, p0, Lio/fabric/sdk/android/t;->k:Ljava/lang/String;

    iget-object v5, p0, Lio/fabric/sdk/android/t;->l:Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v6}, Lio/fabric/sdk/android/services/settings/q;->a(Lio/fabric/sdk/android/p;Lio/fabric/sdk/android/services/common/IdManager;Lio/fabric/sdk/android/services/network/j;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lio/fabric/sdk/android/services/settings/q;
...
.method a(Ljava/util/Map;Ljava/util/Collection;)Ljava/util/Map;
    ...
    new-instance v3, Lio/fabric/sdk/android/r;
    ...
    invoke-direct {v3, v4, v0, v5}, Lio/fabric/sdk/android/r;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method protected a_()Z
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/t;->m:Ljava/lang/String;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/t;->b:Landroid/content/pm/PackageManager;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/t;->c:Ljava/lang/String;

    .line 78
    iget-object v1, p0, Lio/fabric/sdk/android/t;->b:Landroid/content/pm/PackageManager;

    iget-object v2, p0, Lio/fabric/sdk/android/t;->c:Ljava/lang/String;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/t;->d:Landroid/content/pm/PackageInfo;

    .line 79
    iget-object v1, p0, Lio/fabric/sdk/android/t;->d:Landroid/content/pm/PackageInfo;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/t;->k:Ljava/lang/String;
    ...
    :goto_0
    iput-object v1, p0, Lio/fabric/sdk/android/t;->l:Ljava/lang/String;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/t;->n:Ljava/lang/String;
    ...
    iput-object v1, p0, Lio/fabric/sdk/android/t;->o:Ljava/lang/String;
...
.method protected d()Ljava/lang/Boolean;
    ...
    .line 99
    invoke-direct {p0}, Lio/fabric/sdk/android/t;->g()Lio/fabric/sdk/android/services/settings/v;
    ...
    .line 104
    :try_start_0
    iget-object v0, p0, Lio/fabric/sdk/android/t;->p:Ljava/util/concurrent/Future;
    ...
    .line 111
    :goto_0
    iget-object v4, p0, Lio/fabric/sdk/android/t;->q:Ljava/util/Collection;

    invoke-virtual {p0, v0, v4}, Lio/fabric/sdk/android/t;->a(Ljava/util/Map;Ljava/util/Collection;)Ljava/util/Map;

    move-result-object v0

    .line 112
    iget-object v3, v3, Lio/fabric/sdk/android/services/settings/v;->a:Lio/fabric/sdk/android/services/settings/e;

    invoke-interface {v0}, Ljava/util/Map;->values()Ljava/util/Collection;

    move-result-object v0

    invoke-direct {p0, v2, v3, v0}, Lio/fabric/sdk/android/t;->a(Ljava/lang/String;Lio/fabric/sdk/android/services/settings/e;Ljava/util/Collection;)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected synthetic f()Ljava/lang/Object;
    ...
    .prologue
    .line 45
    invoke-virtual {p0}, Lio/fabric/sdk/android/t;->d()Ljava/lang/Boolean;
