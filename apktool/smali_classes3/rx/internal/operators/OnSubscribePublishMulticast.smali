...
# static fields
.field static final a:[Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
...
.field static final b:[Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
            "Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer",
...
.field final parent:Lrx/internal/operators/l;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lrx/internal/operators/OnSubscribePublishMulticast;->a:[Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;

    .line 92
    new-array v0, v1, [Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;

    sput-object v0, Lrx/internal/operators/OnSubscribePublishMulticast;->b:[Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;
...
.method public constructor <init>(IZ)V
    ...
    invoke-direct {v0, p1}, Ldep;-><init>(I)V

    iput-object v0, p0, Lrx/internal/operators/OnSubscribePublishMulticast;->queue:Ljava/util/Queue;

    .line 112
    :goto_0
    sget-object v0, Lrx/internal/operators/OnSubscribePublishMulticast;->a:[Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;
    ...
    invoke-direct {v0, p0}, Lrx/internal/operators/l;-><init>(Lrx/internal/operators/OnSubscribePublishMulticast;)V

    iput-object v0, p0, Lrx/internal/operators/OnSubscribePublishMulticast;->parent:Lrx/internal/operators/l;
    ...
    invoke-direct {v0, p1}, Lrx/internal/util/atomic/c;-><init>(I)V
...
.method public Q_()V
    ...
    .prologue
    .line 423
    iget-object v0, p0, Lrx/internal/operators/OnSubscribePublishMulticast;->parent:Lrx/internal/operators/l;

    invoke-virtual {v0}, Lrx/internal/operators/l;->Q_()V
...
.method public a(Ljava/lang/Throwable;)V
    ...
    .line 153
    invoke-virtual {p0}, Lrx/internal/operators/OnSubscribePublishMulticast;->c()V
...
.method public a(Lrx/an;)V
    ...
    invoke-direct {v0, p1, p0}, Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;-><init>(Lrx/an;Lrx/internal/operators/OnSubscribePublishMulticast;)V
    ...
    .line 122
    invoke-virtual {p0, v0}, Lrx/internal/operators/OnSubscribePublishMulticast;->a(Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;)Z
    ...
    .line 123
    invoke-virtual {v0}, Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;->b()Z
    ...
    .line 124
    invoke-virtual {p0, v0}, Lrx/internal/operators/OnSubscribePublishMulticast;->b(Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;)V
...
.method a(Lrx/s;)V
    ...
    .prologue
    .line 167
    iput-object p1, p0, Lrx/internal/operators/OnSubscribePublishMulticast;->producer:Lrx/s;
...
.method a(Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;)Z
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 317
    sget-object v2, Lrx/internal/operators/OnSubscribePublishMulticast;->b:[Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;
...
.method a(ZZ)Z
    ...
    .line 257
    invoke-virtual {p0}, Lrx/internal/operators/OnSubscribePublishMulticast;->d()[Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;
    ...
    .line 261
    iget-object v5, v5, Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;->actual:Lrx/an;
    ...
    .line 265
    iget-object v4, v4, Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;->actual:Lrx/an;
    ...
    invoke-virtual {v5, v2}, Lrx/an;->a(Ljava/lang/Throwable;)V
...
.method b(Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v2, Lrx/internal/operators/OnSubscribePublishMulticast;->a:[Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;
    ...
    .line 348
    sget-object v1, Lrx/internal/operators/OnSubscribePublishMulticast;->b:[Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;

    if-eq v2, v1, :cond_2

    sget-object v1, Lrx/internal/operators/OnSubscribePublishMulticast;->a:[Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;
...
.method public b()Z
    ...
    invoke-virtual {v0}, Lrx/internal/operators/l;->b()Z
...
.method c()V
    ...
    .line 207
    :goto_3
    invoke-virtual {p0, v3, v2}, Lrx/internal/operators/OnSubscribePublishMulticast;->a(ZZ)Z
    ...
    invoke-virtual {p0, v2, v3}, Lrx/internal/operators/OnSubscribePublishMulticast;->a(ZZ)Z
    ...
    .line 229
    iget-object v2, p0, Lrx/internal/operators/OnSubscribePublishMulticast;->producer:Lrx/s;
    ...
    .line 234
    invoke-static {v8, v4, v5}, Lrx/internal/operators/a;->b(Ljava/util/concurrent/atomic/AtomicLong;J)J
    ...
    .line 216
    iget-object v13, v13, Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;->actual:Lrx/an;

    invoke-virtual {v13, v12}, Lrx/an;->b_(Ljava/lang/Object;)V
...
.method public synthetic call(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lrx/internal/operators/OnSubscribePublishMulticast;->a(Lrx/an;)V

    return-void
.end method

.method d()[Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()[",
    ...
    .line 302
    sget-object v0, Lrx/internal/operators/OnSubscribePublishMulticast;->b:[Lrx/internal/operators/OnSubscribePublishMulticast$PublishProducer;
