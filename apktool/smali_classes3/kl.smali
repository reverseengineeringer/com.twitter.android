...
.method private static a(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v0}, Lkl;->a(Ljava/lang/Class;)Ljava/lang/Object;
    :try_end_0
...
.method public static a(Landroid/content/Context;)Lkp;
    ...
    :cond_0
    invoke-static {p0}, Lkl;->b(Landroid/content/Context;)V

    invoke-static {p0}, Lkl;->c(Landroid/content/Context;)Lkp;

    move-result-object v0

    sput-object v0, Lkl;->b:Lkp;

    :try_start_0
    sget-object v0, Lkl;->b:Lkp;

    invoke-static {p0}, Lkl;->d(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-interface {v0, v1, v2}, Lkp;->a(Lcom/google/android/gms/dynamic/j;I)V
    :try_end_0
...
.method private static c(Landroid/content/Context;)Lkp;
    .locals 2

    invoke-static {}, Lkl;->a()Z
    ...
    invoke-static {}, Lkl;->b()Ljava/lang/Class;
    ...
    invoke-static {v0, v1}, Lkl;->a(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/os/IBinder;

    invoke-static {v0}, Lkq;->a(Landroid/os/IBinder;)Lkp;
...
.method private static d(Landroid/content/Context;)Landroid/content/Context;
    ...
    sget-object v0, Lkl;->a:Landroid/content/Context;
    ...
    sput-object v0, Lkl;->a:Landroid/content/Context;
