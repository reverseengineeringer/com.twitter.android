.class public Lcom/twitter/android/MutedAccountsActivity;
...
.method private m()V
    ...
    invoke-virtual {p0, v2, v3}, Lcom/twitter/android/MutedAccountsActivity;->a(II)Lcom/twitter/app/users/aa;
    ...
    invoke-virtual {p0, v0, v1, v2, v3}, Lcom/twitter/android/MutedAccountsActivity;->a(Ljava/lang/String;ILandroid/os/Bundle;Ljava/lang/Class;)V
...
.method private r()V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/twitter/android/MutedAccountsActivity;->a(II)Lcom/twitter/app/users/aa;
    ...
    .line 60
    const-string/jumbo v1, "automated"

    const v2, 0x7f0a053e

    const-class v3, Lcom/twitter/app/users/UsersFragment;

    invoke-virtual {p0, v1, v2, v0, v3}, Lcom/twitter/android/MutedAccountsActivity;->a(Ljava/lang/String;ILandroid/os/Bundle;Ljava/lang/Class;)V
...
.method protected a(II)Lcom/twitter/app/users/aa;
    ...
    .line 66
    invoke-virtual {p0}, Lcom/twitter/android/MutedAccountsActivity;->getIntent()Landroid/content/Intent;

    move-result-object v0

    const-string/jumbo v1, "target_session_owner_id"

    invoke-virtual {p0}, Lcom/twitter/android/MutedAccountsActivity;->ab()Lcom/twitter/library/client/Session;
    ...
    iget-object v1, p0, Lcom/twitter/android/MutedAccountsActivity;->g:Lcom/twitter/library/util/FriendshipCache;
...
.method public b(Landroid/os/Bundle;Lcom/twitter/app/common/base/t;)V
    ...
    iput v0, p0, Lcom/twitter/android/MutedAccountsActivity;->a:I
    ...
    invoke-virtual {p0, v0}, Lcom/twitter/android/MutedAccountsActivity;->setTitle(I)V
    ...
    iput-object v0, p0, Lcom/twitter/android/MutedAccountsActivity;->g:Lcom/twitter/library/util/FriendshipCache;

    .line 35
    invoke-direct {p0}, Lcom/twitter/android/MutedAccountsActivity;->m()V

    .line 36
    invoke-direct {p0}, Lcom/twitter/android/MutedAccountsActivity;->r()V
