  ...
  extends mm
{
  ...
  protected String a(String paramString, HashMap<String, String> paramHashMap)
  {
    ...
    catch (PackageManager.NameNotFoundException localNameNotFoundException)
    {
      for (;;)
      {
        qd.d("Error to retrieve app version", localNameNotFoundException);
        str2 = "";
      }
    }
  ...
  void b()
  {
    ...
    {
      qd.d("Google Conversion Tracking SDK 1.2.0 or above is required to report a conversion.");
      return;
    }
    ...
    {
      qd.d("Fail to report a conversion.", localException);
    }
  }
