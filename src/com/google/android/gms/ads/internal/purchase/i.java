...
public class i
{
  ...
  public SQLiteDatabase a()
  {
    ...
    {
      qd.d("Error opening writable conversion tracking database");
    }
    return null;
  }
  ...
  public java.util.List<g> a(long paramLong)
  {
    ...
    //   5: aload 7
    //   7: monitorenter
    //   8: new 95	java/util/LinkedList
    //   11: dup
    //   12: invokespecial 96	java/util/LinkedList:<init>	()V
    //   15: astore 8
    //   17: lload_1
    //   18: lconst_0
    //   19: lcmp
    ...
    //   28: areturn
    //   29: aload_0
    //   30: invokevirtual 98	com/google/android/gms/ads/internal/purchase/i:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   33: astore 4
    //   35: aload 4
    //   37: ifnonnull +9 -> 46
    //   40: aload 7
    ...
    //   55: ldc 100
    //   57: lload_1
    //   58: invokestatic 104	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   61: invokevirtual 110	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   64: astore 5
    //   66: aload 5
    //   68: astore 4
    //   70: aload 5
    //   72: invokeinterface 114 1 0
    //   77: ifeq +37 -> 114
    //   80: aload 5
    //   82: astore 4
    //   84: aload 8
    //   86: aload_0
    //   87: aload 5
    //   89: invokevirtual 116	com/google/android/gms/ads/internal/purchase/i:a	(Landroid/database/Cursor;)Lcom/google/android/gms/ads/internal/purchase/g;
    //   92: invokeinterface 122 2 0
    //   97: pop
    //   98: aload 5
    //   100: astore 4
    //   102: aload 5
    ...
    //   137: aload 5
    //   139: astore 4
    //   141: new 130	java/lang/StringBuilder
    //   144: dup
    //   145: invokespecial 131	java/lang/StringBuilder:<init>	()V
    //   148: ldc -123
    //   150: invokevirtual 137	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   153: aload 6
    //   155: invokevirtual 140	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    //   158: invokevirtual 137	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   161: invokevirtual 143	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   164: invokestatic 76	com/google/android/gms/internal/qd:d	(Ljava/lang/String;)V
    //   167: aload 5
    //   169: ifnull -43 -> 126
    //   172: aload 5
  ...
  public int b()
  {
    ...
    catch (SQLiteException localSQLiteException)
    {
      for (;;)
      {
        ...
        qd.d("Error getting record count" + localSQLiteException.getMessage());
  ...
  public void c()
  {
    ...
    //   7: monitorenter
    //   8: aload_0
    //   9: invokevirtual 98	com/google/android/gms/ads/internal/purchase/i:a	()Landroid/database/sqlite/SQLiteDatabase;
    //   12: astore_1
    //   13: aload_1
    //   14: ifnonnull +7 -> 21
    //   17: aload 4
    ...
    //   29: ldc 100
    //   31: ldc -51
    //   33: invokevirtual 110	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   36: astore_2
    //   37: aload_2
    //   38: ifnull +25 -> 63
    //   41: aload_2
    ...
    //   55: aload_0
    //   56: aload_2
    //   57: invokevirtual 116	com/google/android/gms/ads/internal/purchase/i:a	(Landroid/database/Cursor;)Lcom/google/android/gms/ads/internal/purchase/g;
    //   60: invokevirtual 207	com/google/android/gms/ads/internal/purchase/i:a	(Lcom/google/android/gms/ads/internal/purchase/g;)V
    //   63: aload_2
    //   64: ifnull +9 -> 73
    //   67: aload_2
    ...
    //   86: aload_2
    //   87: astore_1
    //   88: new 130	java/lang/StringBuilder
    //   91: dup
    //   92: invokespecial 131	java/lang/StringBuilder:<init>	()V
    //   95: ldc -47
    //   97: invokevirtual 137	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   100: aload_3
    //   101: invokevirtual 140	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    //   104: invokevirtual 137	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   107: invokevirtual 143	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   110: invokestatic 76	com/google/android/gms/internal/qd:d	(Ljava/lang/String;)V
    //   113: aload_2
    //   114: ifnull -41 -> 73
    //   117: aload_2
