...
public class k
{
  public int a(Intent paramIntent)
  {
    ...
    if (paramIntent == null)
    {
      qd.d("Intent with no response code, assuming OK (known issue)");
      return 0;
    }
    ...
    qd.d("Unexpected type for intent response code. " + paramIntent.getClass().getName());
    return 5;
  }
  ...
  public int a(Bundle paramBundle)
  {
    ...
    if (paramBundle == null)
    {
      qd.d("Bundle with null response code, assuming OK (known issue)");
      return 0;
    }
    ...
    qd.d("Unexpected type for intent response code. " + paramBundle.getClass().getName());
    return 5;
  }
  ...
  public String a(String paramString)
  {
    ...
    {
      qd.d("Fail to parse purchase data");
    }
    return null;
  }
