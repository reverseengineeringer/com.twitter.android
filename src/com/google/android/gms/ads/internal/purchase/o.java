...
public class o
{
  public static PublicKey a(String paramString)
  {
    ...
    {
      qd.b("Invalid key specification.");
  ...
  public static boolean a(String paramString1, String paramString2, String paramString3)
  {
    ...
    {
      qd.b("Purchase verification failed: missing data.");
      return false;
    }
  ...
  public static boolean a(PublicKey paramPublicKey, String paramString1, String paramString2)
  {
    try
    {
      ...
      {
        qd.b("Signature verification failed.");
        return false;
      }
      return true;
    }
