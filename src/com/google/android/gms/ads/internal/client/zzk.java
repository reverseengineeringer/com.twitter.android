...
public final class zzk
{
  ...
  {
    paramContext = paramContext.getResources().obtainAttributes(paramAttributeSet, if.AdsAttrs);
    paramAttributeSet = paramContext.getString(if.AdsAttrs_adSize);
    String str = paramContext.getString(if.AdsAttrs_adSizes);
    int i;
    ...
    {
      b = paramContext.getString(if.AdsAttrs_adUnitId);
