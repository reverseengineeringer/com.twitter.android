  ...
  implements SafeParcelable
{
  ...
  public AdSizeParcel(Context paramContext, g[] paramArrayOfg)
  {
    ...
    if (j)
    {
      ...
      if ((!aa.a().c(paramContext)) || (!aa.a().d(paramContext))) {
        break label324;
      }
      g = (a(localDisplayMetrics) - aa.a().e(paramContext));
      double d1 = g / density;
      i2 = (int)d1;
      m = i2;
      if (d1 - (int)d1 >= 0.01D) {
      ...
      label180:
      d = aa.a().a(localDisplayMetrics, i2);
      if ((n == 0) && (i1 == 0)) {
        break label370;
      }
      b = (m + "x" + i2 + "_as");
    ...
    for (;;)
    {
      ...
      h = new AdSizeParcel[paramArrayOfg.length];
      m = 0;
      while (m < paramArrayOfg.length)
      {
        h[m] = new AdSizeParcel(paramContext, paramArrayOfg[m]);
        m += 1;
      }
      f = localg.b();
      c = localg.a();
      ...
      label336:
      m = f;
      g = aa.a().a(localDisplayMetrics, f);
      break label168;
      label361:
      i2 = c;
      break label180;
