  ...
  implements r
{
  ...
  public zzk(Context paramContext, sz paramsz, int paramInt, cy paramcy, cu paramcu)
  {
    super(paramContext);
    a = paramsz;
    ...
    g.a(paramsz.h());
    d = hb.a(paramContext, paramsz, paramInt, paramcy, paramcu);
    if (d != null) {
  ...
  public static void a(sz paramsz)
  {
    ...
    paramsz.a("onVideoEvent", localHashMap);
  }
