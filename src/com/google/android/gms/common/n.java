...
public class n
{
  ...
  {
    return f.b().a(paramContext, paramInt1, paramInt2);
  }
  ...
  public static int isGooglePlayServicesAvailable(Context paramContext)
  {
    ...
    try
    {
      paramContext.getResources().getString(ie.common_google_play_services_unknown_issue);
    ...
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        try
        {
          ...
          if (localo.a(localPackageInfo, k.a) != null) {
            break label180;
          }
    ...
    try
    {
      paramContext = localo.a(localPackageManager.getPackageInfo("com.android.vending", 8256), k.a);
    ...
    if (localo.a(localThrowable, new h[] { paramContext }) == null)
    {
      Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
      return 9;
    }
    label180:
    int i = vo.a(GOOGLE_PLAY_SERVICES_VERSION_CODE);
    if (vo.a(versionCode) < i)
    {
  ...
  {
    int i = f.b().a(paramContext);
    if (i != 0)
    {
      paramContext = f.b().a(paramContext, i, "e");
  ...
  public static boolean zzap(Context paramContext)
  {
    ...
    return (vu.j()) && (paramContext.hasSystemFeature("cn.google"));
  }
    ...
    for (boolean bool = true;; bool = false) {
      synchronized (zzqy)
      {
        ...
        try
        {
          ...
          if (o.a().a(paramPackageManager, new h[] { k.a[1] }) != null) {}
  ...
  {
    return f.b().a(null, paramInt, null);
  }
  ...
  public static boolean zzf(Context paramContext, int paramInt)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        return o.a().a(paramContext.getPackageManager(), (PackageInfo)localObject);
      }
      catch (PackageManager.NameNotFoundException paramContext) {}
