  ...
  extends BroadcastReceiver
{
  ...
  public static boolean a(Context paramContext)
  {
    ...
    boolean bool = ag.a(paramContext, AppMeasurementReceiver.class, false);
  ...
  {
    Object localObject = bx.a(paramContext);
    localbc = ((bx)localObject).f();
    ??? = ???.getAction();
    if (((bx)localObject).d().N()) {
      localbc.z().a("Device AppMeasurementReceiver got", ???);
    }
    for (;;)
    {
      boolean bool;
      ...
      synchronized (a)
      {
        ...
        {
          return;
          localbc.z().a("Local AppMeasurementReceiver got", ???);
          continue;
        }
        try
        {
          if (b == null)
          {
            b = new xh(paramContext, 1, "AppMeasurement WakeLock");
            b.a(false);
          }
          b.a(1000L);
        }
        catch (SecurityException paramContext)
        {
          for (;;)
          {
            localbc.c().a("AppMeasurementService at risk of not starting. For more reliable app measurements, add the WAKE_LOCK permission to your manifest.");
          }
        }
        return;
      }
