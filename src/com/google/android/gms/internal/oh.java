  ...
  implements Thread.UncaughtExceptionHandler
{
  ...
  public oh(Context paramContext, VersionInfoParcel paramVersionInfoParcel, Thread.UncaughtExceptionHandler paramUncaughtExceptionHandler1, Thread.UncaughtExceptionHandler paramUncaughtExceptionHandler2)
  {
  ...
  public static oh a(Context paramContext, Thread paramThread, VersionInfoParcel paramVersionInfoParcel)
  {
    ...
    paramContext = new oh(paramContext, paramVersionInfoParcel, localUncaughtExceptionHandler, Thread.getDefaultUncaughtExceptionHandler());
    if ((localUncaughtExceptionHandler == null) || (!(localUncaughtExceptionHandler instanceof oh))) {
      try
      {
      ...
      {
        qd.c("Fail to set UncaughtExceptionHandler.", paramContext);
        return null;
      }
    }
    return (oh)localUncaughtExceptionHandler;
  }
  ...
  public void a(Throwable paramThrowable, boolean paramBoolean)
  {
    ...
    ar.e().a(c, d.b, localArrayList, ar.h().h());
  }
  ...
  protected boolean a(String paramString)
  {
    ...
    try
    {
      boolean bool = Class.forName(paramString).isAnnotationPresent(oi.class);
      return bool;
    }
    catch (Exception localException)
    {
      qd.a("Fail to check class type for class " + paramString, localException);
    }
    return false;
  }
