...
public class ll
  extends lv
{
  static final Set<String> a = vk.a(new String[] { "top-left", "top-right", "top-center", "center", "bottom-left", "bottom-right", "bottom-center" });
  ...
  public ll(sz paramsz, lw paramlw)
  {
    super(paramsz, "resize");
    k = paramsz;
    l = paramsz.f();
    p = paramlw;
  }
  ...
  private int[] d()
  {
    ...
    int[] arrayOfInt1 = ar.e().b(l);
    int[] arrayOfInt2 = ar.e().d(l);
  ...
  public void a(int paramInt1, int paramInt2, boolean paramBoolean)
  {
    synchronized (j)
    {
      ...
      if ((q != null) && (paramBoolean))
      {
        ...
        if (arrayOfInt != null)
        {
          q.update(aa.a().a(l, arrayOfInt[0]), aa.a().a(l, arrayOfInt[1]), q.getWidth(), q.getHeight());
  ...
  public void a(Map<String, String> paramMap)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      localObject2 = new RelativeLayout.LayoutParams(aa.a().a(l, 50), aa.a().a(l, 50));
      String str = b;
      switch (str.hashCode())
      {
      }
      for (;;)
      {
        ...
        for (;;)
        {
          o.setOnClickListener(new lm(this));
          o.setContentDescription("Close button");
          r.addView(o, (ViewGroup.LayoutParams)localObject2);
          try
          {
            q.showAtLocation(paramMap.getDecorView(), 0, aa.a().a(l, arrayOfInt[0]), aa.a().a(l, arrayOfInt[1]));
  ...
  {
    a(paramInt1, paramInt2 - ar.e().d(l)[0], i, f);
  }
  ...
  boolean c()
  {
    Object localObject = ar.e().b(l);
    int[] arrayOfInt = ar.e().d(l);
    int i3 = localObject[0];
    int i1 = localObject[1];
    if ((i < 50) || (i > i3))
    {
      qd.d("Width is too small or too large.");
      return false;
    }
    if ((f < 50) || (f > i1))
    {
      qd.d("Height is too small or too large.");
      return false;
    }
    if ((f == i1) && (i == i3))
    {
      qd.d("Cannot resize to a full-screen ad.");
      return false;
    }
    label188:
    int i2;
