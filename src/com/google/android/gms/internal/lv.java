...
public class lv
{
  ...
  public lv(sz paramsz)
  {
    this(paramsz, "");
  }
  
  public lv(sz paramsz, String paramString)
  {
    a = paramsz;
    b = paramString;
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    {
      qd.b("Error occured while dispatching size change.", localJSONException);
    }
  }
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat, int paramInt5)
  {
    ...
    {
      qd.b("Error occured while obtaining screen information.", localJSONException);
    }
  }
  ...
  public void b(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    {
      qd.b("Error occured while dispatching default position.", localJSONException);
    }
  }
  ...
  public void b(String paramString)
  {
    ...
    {
      qd.b("Error occurred while dispatching error event.", paramString);
    }
  }
  ...
  public void c(String paramString)
  {
    ...
    {
      qd.b("Error occured while dispatching ready Event.", paramString);
    }
  }
  ...
  public void d(String paramString)
  {
    ...
    {
      qd.b("Error occured while dispatching state change.", paramString);
    }
  }
}
