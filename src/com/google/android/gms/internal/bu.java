...
public class bu
{
  ...
  static String a(String[] paramArrayOfString, int paramInt1, int paramInt2)
  {
    ...
    {
      qd.b("Unable to construct shingle");
      return "";
    }
  ...
  static void a(int paramInt1, long paramLong, String paramString, int paramInt2, PriorityQueue<bv> paramPriorityQueue)
  {
    paramString = new bv(paramLong, paramString, paramInt2);
  ...
  public static void a(String[] paramArrayOfString, int paramInt1, int paramInt2, PriorityQueue<bv> paramPriorityQueue)
  {
    ...
    for (;;)
    {
      ...
      {
        l1 = a(bs.a(paramArrayOfString[(i - 1)]), bs.a(paramArrayOfString[(i + paramInt2 - 1)]), l1, l2, 16785407L);
  ...
  {
    long l = (bs.a(paramArrayOfString[paramInt1]) + 2147483647L) % 1073807359L;
    int i = paramInt1 + 1;
    while (i < paramInt1 + paramInt2)
    {
      l = (l * 16785407L % 1073807359L + (bs.a(paramArrayOfString[i]) + 2147483647L) % 1073807359L) % 1073807359L;
      i += 1;
    }
    return l;
  }
