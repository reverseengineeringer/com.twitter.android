...
class hw
{
  ...
  hw(AdRequestParcel paramAdRequestParcel, String paramString, int paramInt)
  {
  ...
  hw(ht paramht)
  {
    this(paramht.a(), paramht.c(), paramht.b());
  }
  
  hw(String paramString)
    throws IOException
  {
  ...
  String a()
  {
    ...
    {
      qd.b("QueueSeed encode failed because UTF-8 is not available.");
      return "";
    }
    finally
    {
