...
public final class jn
{
  ...
  public jn(JSONObject paramJSONObject)
    throws JSONException
  {
    ...
    f = ar.r().a(paramJSONObject, "clickurl");
    g = ar.r().a(paramJSONObject, "imp_urls");
    i = ar.r().a(paramJSONObject, "video_start_urls");
    j = ar.r().a(paramJSONObject, "video_complete_urls");
    ...
    for (localObject1 = ((JSONObject)localObject1).toString();; localObject1 = null)
    {
      ...
      n = ar.r().a(paramJSONObject, "template_ids");
