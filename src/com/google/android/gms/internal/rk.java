...
public class rk
{
  ...
  private void a()
  {
    ...
    {
      qd.c("Can not create dialog without Activity Context");
      return;
    }
    String str = b(b);
    ...
    localBuilder.setPositiveButton("Share", new rl(this, str));
    localBuilder.setNegativeButton("Close", new rm(this));
  ...
  static String b(String paramString)
  {
    ...
    do
    {
      ...
      localObject = ar.e().a((Uri)localObject);
...
/* Location:
 * Qualified Name:     com.google.android.gms.internal.rk
