  ...
  extends WebChromeClient
{
  ...
  private final Context a(WebView paramWebView)
  {
    ...
    {
      return paramWebView;
      localsz = (sz)paramWebView;
      localActivity = localsz.f();
      paramWebView = localActivity;
    } while (localActivity != null);
    return localsz.getContext();
  }
  
  private static void a(AlertDialog.Builder paramBuilder, String paramString, JsResult paramJsResult)
  {
    paramBuilder.setMessage(paramString).setPositiveButton(17039370, new tp(paramJsResult)).setNegativeButton(17039360, new to(paramJsResult)).setOnCancelListener(new tn(paramJsResult)).create().show();
  }
  ...
  private static void a(Context paramContext, AlertDialog.Builder paramBuilder, String paramString1, String paramString2, JsPromptResult paramJsPromptResult)
  {
    ...
    paramBuilder.setView(localLinearLayout).setPositiveButton(17039370, new ts(paramJsPromptResult, paramContext)).setNegativeButton(17039360, new tr(paramJsPromptResult)).setOnCancelListener(new tq(paramJsPromptResult)).create().show();
  }
  
  private final boolean a()
  {
    return (ar.e().a(a.getContext().getPackageManager(), a.getContext().getPackageName(), "android.permission.ACCESS_FINE_LOCATION")) || (ar.e().a(a.getContext().getPackageManager(), a.getContext().getPackageName(), "android.permission.ACCESS_COARSE_LOCATION"));
  }
  ...
  protected final void a(View paramView, int paramInt, WebChromeClient.CustomViewCallback paramCustomViewCallback)
  {
    ...
    if (localzzd == null)
    {
      qd.d("Could not get ad overlay when showing custom view.");
  ...
  protected boolean a(Context paramContext, String paramString1, String paramString2, String paramString3, JsResult paramJsResult, JsPromptResult paramJsPromptResult, boolean paramBoolean)
  {
    ...
    {
      qd.d("Fail to display Dialog.", paramContext);
    }
    return true;
  }
  ...
  public final void onCloseWindow(WebView paramWebView)
  {
    if (!(paramWebView instanceof sz))
    {
      qd.d("Tried to close a WebView that wasn't an AdWebView.");
      return;
    }
    paramWebView = ((sz)paramWebView).i();
    if (paramWebView == null)
    {
      qd.d("Tried to close an AdWebView not associated with an overlay.");
      return;
    }
    paramWebView.a();
  }
  ...
  public final boolean onConsoleMessage(ConsoleMessage paramConsoleMessage)
  {
    ...
    switch (tt.a[paramConsoleMessage.messageLevel().ordinal()])
    {
    default: 
      qd.c(str);
    }
  ...
  public final void onHideCustomView()
  {
    ...
    if (localzzd == null)
    {
      qd.d("Could not get ad overlay when hiding custom view.");
      return;
    }
    localzzd.b();
  }
