...
public class px
{
  ...
  public static boolean a(Context paramContext)
  {
    ...
    if (i == 0)
    {
      qd.c("Please set theme of AdActivity to @android:style/Theme.Translucent to enable transparent background interstitial ad.");
      return false;
    }
    ...
    {
      qd.d("Fail to fetch AdActivity theme");
      qd.c("Please set theme of AdActivity to @android:style/Theme.Translucent to enable transparent background interstitial ad.");
    }
    return false;
  }
