...
public class bf
{
  ...
  public bf(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    a = paramInt1;
    b = paramInt2;
    c = paramInt3;
  ...
  public void a(String arg1, boolean paramBoolean)
  {
    ...
    {
      if (j < 0) {
        qd.a("ActivityContent: negative number of WebViews.");
      }
      g();
      return;
    }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((((bf)paramObject).b() == null) || (!((bf)paramObject).b().equals(b())));
    return true;
  }
