...
class ObjectUtils$InverseComparator<T extends Comparable<T>>
  implements Serializable, Comparator<T>
{
  public static final Comparator a = new InverseComparator();
...
/* Location:
 * Qualified Name:     com.twitter.util.object.ObjectUtils.InverseComparator
