...
class MutableMap$ExternalizableHashMap<K, V>
  extends HashMap<K, V>
  implements Externalizable
{
  private static final long serialVersionUID = 3801550319325993065L;
  
  public MutableMap$ExternalizableHashMap() {}
  
  MutableMap$ExternalizableHashMap(int paramInt)
  {
    super(paramInt);
  }
...
/* Location:
 * Qualified Name:     com.twitter.util.collection.MutableMap.ExternalizableHashMap
