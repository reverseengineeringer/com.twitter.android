...
class MediaBrowserCompat$MediaBrowserServiceImplBase
  implements MediaBrowserCompat.MediaBrowserImpl, MediaBrowserCompat.MediaBrowserServiceCallbackImpl
{
  ...
  public MediaBrowserCompat$MediaBrowserServiceImplBase(Context paramContext, ComponentName paramComponentName, MediaBrowserCompat.ConnectionCallback paramConnectionCallback, Bundle paramBundle)
  {
  ...
  public void connect()
  {
    ...
    MediaBrowserCompat.MediaBrowserServiceImplBase.MediaServiceConnection localMediaServiceConnection = new MediaBrowserCompat.MediaBrowserServiceImplBase.MediaServiceConnection(this, null);
    ...
    if (i == 0) {
      mHandler.post(new MediaBrowserCompat.MediaBrowserServiceImplBase.1(this, localMediaServiceConnection));
    }
  }
  ...
  public void getItem(@NonNull String paramString, @NonNull MediaBrowserCompat.ItemCallback paramItemCallback)
  {
    ...
    if (mState != 2)
    {
      ...
      mHandler.post(new MediaBrowserCompat.MediaBrowserServiceImplBase.2(this, paramItemCallback, paramString));
      return;
    }
    ...
    catch (RemoteException localRemoteException)
    {
      ...
      mHandler.post(new MediaBrowserCompat.MediaBrowserServiceImplBase.3(this, paramItemCallback, paramString));
    }
  }
...
/* Location:
 * Qualified Name:     android.support.v4.media.MediaBrowserCompat.MediaBrowserServiceImplBase
