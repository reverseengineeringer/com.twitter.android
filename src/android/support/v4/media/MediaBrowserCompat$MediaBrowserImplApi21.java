  ...
  implements MediaBrowserCompat.ConnectionCallback.ConnectionCallbackInternal, MediaBrowserCompat.MediaBrowserImpl, MediaBrowserCompat.MediaBrowserServiceCallbackImpl
{
  ...
  public void getItem(@NonNull String paramString, @NonNull MediaBrowserCompat.ItemCallback paramItemCallback)
  {
    ...
    if (!MediaBrowserCompatApi21.isConnected(mBrowserObj))
    {
      ...
      mHandler.post(new MediaBrowserCompat.MediaBrowserImplApi21.1(this, paramItemCallback, paramString));
      return;
    }
    if (mServiceBinderWrapper == null)
    {
      mHandler.post(new MediaBrowserCompat.MediaBrowserImplApi21.2(this, paramItemCallback));
      return;
    }
    ...
    catch (RemoteException localRemoteException)
    {
      ...
      mHandler.post(new MediaBrowserCompat.MediaBrowserImplApi21.3(this, paramItemCallback, paramString));
    }
  }
