  ...
  extends IMediaSession.Stub
{
  ...
  public long getFlags()
  {
    synchronized (MediaSessionCompat.MediaSessionImplBase.access$1400(this$0))
    {
      long l = MediaSessionCompat.MediaSessionImplBase.access$900(this$0);
      return l;
    }
  }
  ...
  public PendingIntent getLaunchPendingIntent()
  {
    synchronized (MediaSessionCompat.MediaSessionImplBase.access$1400(this$0))
    {
      PendingIntent localPendingIntent = MediaSessionCompat.MediaSessionImplBase.access$1500(this$0);
  ...
  public ParcelableVolumeInfo getVolumeAttributes()
  {
    ...
    synchronized (MediaSessionCompat.MediaSessionImplBase.access$1400(this$0))
    {
      int m = MediaSessionCompat.MediaSessionImplBase.access$400(this$0);
      int n = MediaSessionCompat.MediaSessionImplBase.access$500(this$0);
      VolumeProviderCompat localVolumeProviderCompat = MediaSessionCompat.MediaSessionImplBase.access$300(this$0);
      if (m == 2)
      {
      ...
      int j = MediaSessionCompat.MediaSessionImplBase.access$1600(this$0).getStreamMaxVolume(n);
      int k = MediaSessionCompat.MediaSessionImplBase.access$1600(this$0).getStreamVolume(n);
    }
  }
  
  public boolean isTransportControlEnabled()
  {
    return (MediaSessionCompat.MediaSessionImplBase.access$900(this$0) & 0x2) != 0;
  }
  ...
  {
    if (MediaSessionCompat.MediaSessionImplBase.access$1000(this$0)) {}
    try
    {
    ...
    MediaSessionCompat.MediaSessionImplBase.access$1100(this$0).register(paramIMediaControllerCallback);
    return;
  }
  ...
  {
    if ((MediaSessionCompat.MediaSessionImplBase.access$900(this$0) & 0x1) != 0) {}
  ...
  {
    MediaSessionCompat.MediaSessionImplBase.access$1100(this$0).unregister(paramIMediaControllerCallback);
  }
}
