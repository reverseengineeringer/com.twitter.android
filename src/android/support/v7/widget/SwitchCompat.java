  ...
  extends CompoundButton
{
  ...
  private void animateThumbToCheckedState(boolean paramBoolean)
  {
    ...
    {
      mPositionAnimator = new SwitchCompat.ThumbAnimation(this, f2, f1, null);
      mPositionAnimator.setDuration(250L);
      mPositionAnimator.setAnimationListener(new SwitchCompat.1(this, paramBoolean));
  ...
  {
    setThumbDrawable(mDrawableManager.getDrawable(getContext(), paramInt));
  }
  ...
  {
    setTrackDrawable(mDrawableManager.getDrawable(getContext(), paramInt));
  }
