...
public final class AppCompatDrawableManager
{
  ...
  private boolean addCachedDelegateDrawable(@NonNull Context paramContext, long paramLong, @NonNull Drawable paramDrawable)
  {
    Drawable.ConstantState localConstantState = paramDrawable.getConstantState();
    if (localConstantState != null) {
      synchronized (mDelegateDrawableCacheLock)
      {
        LongSparseArray localLongSparseArray = (LongSparseArray)mDelegateDrawableCaches.get(paramContext);
  ...
  private Drawable getCachedDelegateDrawable(@NonNull Context paramContext, long paramLong)
  {
    LongSparseArray localLongSparseArray;
    synchronized (mDelegateDrawableCacheLock)
    {
      localLongSparseArray = (LongSparseArray)mDelegateDrawableCaches.get(paramContext);
      if (localLongSparseArray == null) {
        return null;
      }
  ...
  private static boolean tintDrawableUsingColorFilter(@NonNull Context paramContext, @DrawableRes int paramInt, @NonNull Drawable paramDrawable)
  {
  ...
  public final Drawable onDrawableLoadedFromResources(@NonNull Context paramContext, @NonNull TintResources paramTintResources, @DrawableRes int paramInt)
  {
