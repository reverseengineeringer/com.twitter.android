  ...
  extends DrawableWrapper
{
  ...
  {
    super(paramDrawable);
    mShadowStartColor = paramResources.getColor(R.color.design_fab_shadow_start_color);
    mShadowMiddleColor = paramResources.getColor(R.color.design_fab_shadow_mid_color);
    mShadowEndColor = paramResources.getColor(R.color.design_fab_shadow_end_color);
